...
다음 JSON 형식으로 응답해주세요:
{
  ...
  "content": "## 📋 핵심 내용 요약\n\n이 영상의 **핵심 주제**는 [주제]입니다.\n\n**주요 논점:**\n- 첫 번째 핵심 논점과 배경 설명\n- 두 번째 핵심 논점과 구체적 사례\n- 세 번째 핵심 논점과 실무 적용 방안\n\n**결론:**\n영상의 결론과 핵심 메시지를 명확하게 정리",
  "sections": [
    {
      "title": "섹션 제목",
...
요약 시 다음 사항을 준수하세요:
- content 부분은 lilys.ai 스타일의 구조화된 핵심내용 요약으로 작성
- **볼드체**로 핵심 개념과 중요한 용어 강조
- 주요 논점을 3-4개로 명확하게 구분하여 설명
- 각 논점마다 구체적인 배경과 사례를 포함
- 결론 부분에서 영상의 핵심 메시지를 명확히 정리
