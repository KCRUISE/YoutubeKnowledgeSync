...
다음 JSON 형식으로 응답해주세요:
{
  ...
  "content": "영상의 전체적인 요약 내용을 3-4개 문단으로 구조화하여 작성합니다. **볼드체**로 핵심 개념을 강조하고, 중요한 인사이트와 배경 정보를 포함하여 독자가 영상의 핵심 메시지를 명확히 이해할 수 있도록 합니다. 각 문단은 논리적 흐름을 따라 구성하며, 실무적 적용 가능성과 시사점을 포함합니다.",
  "sections": [
    {
      "title": "섹션 제목",
      "timestamp": "예상 시간대 (예: 0:00-5:30)",
      "content": "해당 섹션의 상세 내용을 2-3문장으로 설명",
